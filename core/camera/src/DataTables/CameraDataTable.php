...
namespace Carparkdashboard\Camera\DataTables;
    ...
    public function ajax()
    {
        ...
        return datatables()::of($data)
                 ...
                 ->editColumn('name', function ($item) {
                    return '<a href="'.route('camera.edit',$item->id).'">'.$item->name.'</a>';
                })

                ->editColumn('Operations', function ($item) {
                  //$permission = $this->authorize('view', $item);
                  return '<a href="'.route('camera.edit',$item->id).'" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a><a href="#" class="btn btn-icon btn-danger deleteDialog" data-toggle="modal" data-target="#delete" catid="'.$item->id.'"><i class="fa fa-trash"></i></a>';
                })
        ...
        return $this->builder()
                    ...
                    ->parameters([
                        'buttons' => [
                           ...
                           'className' => 'btn btn-danger action-item deleteCamera',
                           'idName' => 'deleteCamera',
                        ...
                        'language'     => [
                            'info' => view('carparkdashboard-camera::table.table-info')->render(),
                            'search' => '',
